...
<CustomParagraph
children="To get started with React Query, we will need to install it in our project"/>
...
<CustomParagraph
children="In this example, we will build a simple todo list application to showcase React Query's capabilities."/>

## Fetching data

<CustomParagraph 
children="We will start by fetching a list of todos using React Query's useQuery hook."
/>
...
<CustomParagraph 
children="Next we will add a form to add a new todo. We will use React Query's useMutation hook to handle the form submission.
"/>
...
<CustomParagraph 
children="Now, we will add the ability to mark a todo as complete. 
We will use React Query's useMutation hook to handle the form submission." />
...
<CustomParagraph 
children ="Finally, we will add the ability to delete a todo using React Query's useMutation hook 
...
<CustomParagraph 
children="In this article, we built a simple todo list app to demonstrate the core concepts of React Query.
